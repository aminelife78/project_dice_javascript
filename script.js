...
roll_dice.addEventListener('click',()=>{
  ...
  if(rand !== 1 ){
    ...
    document.querySelector(".current-score"+playerEnCours).textContent = resultat_current;
...
function playerNext(){
  playerEnCours = (playerEnCours === "0")? playerEnCours = "1" : playerEnCours = "0";
...
hold.addEventListener("click",()=>{
 ...
 document.querySelector(".myScore-p"+playerEnCours).textContent =  global[playerEnCours];
